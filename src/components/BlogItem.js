...
const BlogItem = ({ blog, content }) => {
  return (
        <div>
            <h1 class="mb-4 mt-4 text-left text-nowrap font-thin tracking-normal text-gray-900 sm:text-lg md:text-lg lg:text-2xl">{blog.title}</h1>
            <p class="leading-snug truncate break-words ml-2 text-center mb-5 text-black" dangerouslySetInnerHTML={{ __html: blog.content}}></p>
            <footer>
